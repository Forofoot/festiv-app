...
function Politic() {
  return (
    ...
    <PoliticStyle>
        ...
        Le site web https://festivap-em.fr/ est détenu par Festiv&apos;App, qui est un contrôleur de données de vos données personnelles.
        </div>
        <div>
            Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par https://festivap-em.fr/, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d&apos;utiliser le site web de https://festivap-em.fr/.
